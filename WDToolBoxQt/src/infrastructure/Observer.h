...
public:
    ...
    // pData: 事件数据（可选）
    virtual void OnDataChanged(const QString& strEventType, void* pData = nullptr) = 0;
};
...
public:
    ...
    // 通知所有观察者
    virtual void NotifyObservers(const QString& strEventType, void* pData = nullptr) = 0;
};
...
public:
    ...
    virtual void NotifyObservers(const QString& strEventType, void* pData = nullptr) override;
